...
function tutorialMarkup() {
  return `<div class="feature-overlay" data-feature-overlay="tutorial"><div class="feature-window tutorial-window"><div class="feature-titlebar"><div><span class="codex-kicker">MANUALE OPERATIVO</span><h2>TUTORIAL COMPLETO</h2><small>Dalla scelta del Developer alla DEADLINE.</small></div><button type="button" class="feature-close" data-feature-close>CHIUDI ×</button></div><div class="tutorial-layout"><aside class="tutorial-nav" data-tutorial-nav></aside><section class="tutorial-main"><div class="tutorial-progress"><span data-tutorial-progress>1 / 20</span><div><i data-tutorial-bar></i></div></div><div class="tutorial-content">
    ...
    <section class="tutorial-section"><span class="tutorial-number">03</span><div><h3>IL TEAM</h3><p>Il team può contenere fino a 3 Developer. Durante un combattimento ne hai 1 attivo e gli altri restano in panchina. I Developer possono essere cambiati quando usi CAMBIO. <b>Le abilità passive dei Developer sono abilità di squadra:</b> quando un membro disponibile possiede una passiva, il suo effetto può beneficiare anche il Developer attivo. Un Developer ESAUSTO non può essere utilizzato finché non viene recuperato.</p></div></section>
    ...
    <section class="tutorial-section"><span class="tutorial-number">12</span><div><h3>EQUIPAGGIAMENTO E TIER</h3><p>Gli oggetti forniscono bonus a CODICE e/o DEBUG. Ogni Developer dispone di 2 slot. Gli oggetti non equipaggiati restano nello ZAINO e possono essere spostati tra ZAINO e Developer dalla schermata EQUIPMENT. Anche gli oggetti sono divisi in <b>TIER 1–4</b> e i loro bonus crescono con il Tier.</p></div></section>
    ...
    <section class="tutorial-section"><span class="tutorial-number">14</span><div><h3>RICOMPENSE E SCALATA DEI TIER</h3><p>Le ricompense possono aggiungere Tool alle CARTE POSSEDUTE e, se il MAZZO ha meno di 20 carte, anche direttamente al MAZZO. Il MAZZO contiene da 5 a 20 carte; le carte rimosse restano possedute e possono essere reinserite. I nodi TOOL danno una carta, mentre i nodi EQUIPAGGIAMENTO danno un oggetto. Il Tier delle ricompense segue la COMMESSA: ogni <b>5 COMMESSE</b> si sale di Tier.</p></div></section>
    ...
    <section class="tutorial-section"><span class="tutorial-number">16</span><div><h3>ELITE, TIER E NEMICI</h3><p>Gli Elite sono combattimenti più impegnativi e usano <b>un Tier superiore</b> rispetto a quello attuale della COMMESSA, fino al TIER 4. I nemici normali, le ricompense, gli oggetti e i Tool seguono il Tier della COMMESSA. I nemici appartengono a categorie diverse e hanno intenzioni, passivi, vantaggi e debolezze differenti. Osserva sempre l'intenzione mostrata in combattimento per capire cosa sta per succedere.</p></div></section>
    <section class="tutorial-section"><span class="tutorial-number">17</span><div><h3>DEADLINE E NUOVA COMMESSA</h3><p>La DEADLINE è il boss della COMMESSA. Lo scontro è diviso in <b>3 fasi casuali</b>: la fase attiva cambia quando la DEADLINE scende sotto circa il 66% e il 33% degli HP. Ogni fase modifica bonus e malus e possiede una <b>abilità speciale</b> che si attiva una sola volta, al primo attacco di quella fase. Dopo aver sconfitto la DEADLINE, il team viene completamente ripristinato, il numero di COMMESSA aumenta, la difficoltà cresce e ricevi una scelta tra 6 ricompense: 3 oggetti e 3 Tool del Tier della COMMESSA. La run riparte con una nuova mappa e TEMPO riportato a 8. Il passaggio di Tier avviene ogni 5 COMMESSE.</p></div></section>
    <section class="tutorial-section"><span class="tutorial-number">18</span><div><h3>NUZLOCKE</h3><p>La modalità Nuzlocke permette di combinare regole speciali prima della run. Puoi limitare guarigione, reclutamento, sostituzioni e cambi, bloccare ZAINO o MAZZO, vietare azioni o categorie di Tool, ridurre Energia o mano, imporre percorsi casuali o ELITE obbligatoria e attivare PERMADEATH. Alcune combinazioni incompatibili vengono bloccate automaticamente.</p></div></section>
