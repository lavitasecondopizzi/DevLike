  ...
  if(game.screen==="menu")return `<section class="panel menu-screen">
    <div class="menu-hero">
      <div class="menu-brand">
        ...
        ${hasLocalSave() ? `<div class="menu-primary-actions"><button type="button" class="primary menu-start" data-action="continue"><span>▶</span> CONTINUA COMMESSA</button><button type="button" class="secondary menu-new-run" data-action="start"><span>↻</span> NUOVA COMMESSA</button><button type="button" class="feature-menu-item menu-leaderboard-action" data-action="leaderboard-open"><span>CLASSIFICA</span><small>RECORD ONLINE</small></button></div>` : `<div class="menu-primary-actions"><button type="button" class="primary menu-start" data-action="start"><span>▶</span> NUOVA COMMESSA</button><button type="button" class="feature-menu-item menu-leaderboard-action" data-action="leaderboard-open"><span>CLASSIFICA</span><small>RECORD ONLINE</small></button></div>`}
