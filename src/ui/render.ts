...
return `<section class="battle battle-redesign">
  ...
  <section class="battle-main">
    ...
    <div class="battle-actions">
      ...
      <button type="button" data-action="defend" ${c.canDefendForUi?"":"disabled"}><b>DIFESA</b><small>${c.team.some(d=>d.classId==="architect"&&d.hp>0&&d.stress<d.maxStress)&&!c.architectDefenseUsed.has("team")?"GRATIS":"COSTO: 1 ⚡"} · +${c.defensePreview} BLOCCO${c.team.some(d=>d.classId==="devops"&&d.passive.includes("Auto-Scaling")&&d.hp>0&&d.stress<d.maxStress)?" · +2 HP":""}${c.nuzlockeRules.includes("noStressRecovery")?" · NESSUN RECUPERO STRESS":" · -3 STRESS"}</small></button>
    </div>
