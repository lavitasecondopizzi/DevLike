...
export const startingDeck:Card[]=[
 ...
 {id:"coffee",name:"COFFEE",cost:0,description:"Aumenta del 15% i danni inflitti per questo turno e aumenta lo Stress di 10.",effect:{type:"codeBoost",amount:15}},
...
export const rewardCards:Card[]=[
 ...
 {id:"jira",name:"JIRA",cost:1,description:"Infligge 15 danni.",effect:{type:"damage",amount:15}},
 ...
 {id:"git-pull",name:"GIT PULL",cost:1,description:"Riduce lo Stress di 8.",effect:{type:"removeStress",amount:8}},
 ...
 {id:"rubber-duck-debug",name:"DEBUG A PAPERA",cost:1,description:"Riduce lo Stress di 10.",effect:{type:"removeStress",amount:10}},
 ...
 {id:"coffee-overdose",name:"CAFFÈ TRIPLO",cost:0,description:"Aumenta del 25% i danni inflitti per questo turno e aumenta lo Stress di 15.",effect:{type:"codeBoost",amount:25}},
 {id:"energy-drink-card",name:"ENERGY DRINK",cost:1,description:"Aumenta del 15% i danni inflitti per questo turno e aumenta lo Stress di 10.",effect:{type:"codeBoost",amount:15}},
 ...
 {id:"ai-slop",name:"AI SLOP",cost:0,description:"Aumenta del 20% i danni inflitti per questo turno e aumenta lo Stress di 12.",effect:{type:"codeBoost",amount:20}}
];
