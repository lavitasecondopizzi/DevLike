...
export class Combat {
  team: Developer[]; activeIndex = 0; enemy: Enemy; energy = 3; block = 0; codeBoost = 0; temporaryCodeBonus = 0; drawPile: Card[]; discardPile: Card[] = []; hand: Card[] = []; result: BattleResult = "ongoing"; log: string[] = []; turn = 1; firstDefenseUsed = false; firstCardPlayed = false; toolPlayedThisTurn = false; enemyScaling = 0; nuzlockeRules: string[] = []; showDeck = false; deckView: "draw" | "discard" = "draw";
  ...
  get canDefendForUi():boolean{
    ...
    return this.energy>=1||(this.active.classId==="architect"&&!this.firstDefenseUsed);
  }
  ...
  get defensePreview():number{return 10+(this.active.classId==="devops"&&!this.devopsFirstDefenseUsed?5:0);}
